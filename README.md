...
**Open-Source Models**:
- specialised for Slovenian: recently-available GaMS models by [CJVT](https://huggingface.co/cjvt): [OPT_GaMS-1B-Chat](https://huggingface.co/cjvt/OPT_GaMS-1B-Chat) in [GaMS-1B-Chat](https://huggingface.co/cjvt/GaMS-1B-Chat), 1B models, developed as part of the POVEJMO project - bigger models will follow as the final products of this project
...
**Benchmarks**:
- RAG benchmark for retrieval capabilities: [PandaChat-RAG Benchmark](https://github.com/TajaKuzman/pandachat-rag-benchmark)
...
- [SloBERTa](https://huggingface.co/EMBEDDIA/sloberta): monolingual Slovene BERT-like model
